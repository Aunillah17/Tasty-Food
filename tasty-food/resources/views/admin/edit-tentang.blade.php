    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card card-branded p-4 p-md-5">
                ...
                <p class="text-muted mb-5">Sesuaikan teks cerita narasi dan upload aset file gambar halaman Tentang melalui form di bawah ini.</p>
                ...
                <form action="/tasty-secret-admin/tentang/update" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label for="tasty_img1" class="form-label fw-bold small text-uppercase text-muted">Gambar 1 (Kiri)</label>
                                @if($tentang->tasty_img1)
                                    <div class="mb-2">
                                        <img src="{{ asset('assets/images/' . $tentang->tasty_img1) }}" alt="Preview" class="img-thumbnail" style="height: 100px; object-fit: cover;">
                                    </div>
                                @endif
                                <input type="file" class="form-control form-control-branded" id="tasty_img1" name="tasty_img1">
                                <small class="text-muted">Format: jpg, png, jpeg, avif, webp. Biarkan kosong jika tidak ingin mengubah.</small>
                            </div>
                            <div class="col-md-6 mb-4">
                                <label for="tasty_img2" class="form-label fw-bold small text-uppercase text-muted">Gambar 2 (Kanan)</label>
                                @if($tentang->tasty_img2)
                                    <div class="mb-2">
                                        <img src="{{ asset('assets/images/' . $tentang->tasty_img2) }}" alt="Preview" class="img-thumbnail" style="height: 100px; object-fit: cover;">
                                    </div>
                                @endif
                                <input type="file" class="form-control form-control-branded" id="tasty_img2" name="tasty_img2">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label for="visi_img1" class="form-label fw-bold small text-uppercase text-muted">Gambar Kotak Visi 1</label>
                                @if($tentang->visi_img1)
                                    <div class="mb-2">
                                        <img src="{{ asset('assets/images/' . $tentang->visi_img1) }}" alt="Preview" class="img-thumbnail" style="height: 100px; object-fit: cover;">
                                    </div>
                                @endif
                                <input type="file" class="form-control form-control-branded" id="visi_img1" name="visi_img1">
                                <small class="text-muted">Biarkan kosong jika tidak ingin mengubah.</small>
                            </div>
                            <div class="col-md-6 mb-4">
                                <label for="visi_img2" class="form-label fw-bold small text-uppercase text-muted">Gambar Kotak Visi 2</label>
                                @if($tentang->visi_img2)
                                    <div class="mb-2">
                                        <img src="{{ asset('assets/images/' . $tentang->visi_img2) }}" alt="Preview" class="img-thumbnail" style="height: 100px; object-fit: cover;">
                                    </div>
                                @endif
                                <input type="file" class="form-control form-control-branded" id="visi_img2" name="visi_img2">
                                <small class="text-muted">Biarkan kosong jika tidak ingin mengubah.</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-4">
                            <label for="misi_img" class="form-label fw-bold small text-uppercase text-muted">Gambar Lebar (Misi)</label>
                            @if($tentang->misi_img)
                                <div class="mb-2">
                                    <img src="{{ asset('assets/images/' . $tentang->misi_img) }}" alt="Preview" class="img-thumbnail" style="height: 100px; object-fit: cover;">
                                </div>
                            @endif
                            <input type="file" class="form-control form-control-branded" id="misi_img" name="misi_img">
                            <small class="text-muted">Biarkan kosong jika tidak ingin mengubah.</small>
                        </div>
                    </div>
